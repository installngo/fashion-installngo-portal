...
export async function POST(req: NextRequest) {
  console.log("POST /api/admin/signup called");
  ...
  try {
    ...
    const { data, error } = await supabaseAdmin
      ...
      .insert({ code, full_name, email_id, password_hash })
      .select()
      .single();
    ...
    console.log("Response ready, returning to client");
    ...
    if (err instanceof Error) {
      ...
      console.error("Unknown catch error:", err);
